...
function draw() {
  ...
  rectMode(CENTER);
  ground.display();
  box1.display("red", "darkblue");
  box2.display("red", "darkblue");
  box3.display("red", "darkblue");
  box4.display("red", "darkblue");
  box5.display("red", "darkblue");
  box6.display("indigo", "darkblue");
  box7.display("indigo", "darkblue");
  box8.display("indigo", "darkblue");
  box9.display("indigo", "darkblue");
  box10.display("pink", "darkblue");
  box11.display("pink", "darkblue");
  box12.display("pink", "darkblue");
  box13.display("orange", "darkblue");
  box14.display("orange", "darkblue");
  box15.display("saffron", "darkblue");
  py1.display(rgb(229, 116, 117), "darkblue")
  py2.display(rgb(229, 116, 117), "darkblue")
  py3.display(rgb(229, 116, 117), "darkblue")
  py4.display(rgb(110, 71, 102), "darkblue")
  py5.display(rgb(110, 71, 102), "darkblue")
  py6.display(rgb(251, 189, 76), "darkblue")
  sling.display("limegreen");
  stand1.display();
  stand2.display();
  ball.display("darkblue", "black");
  textSize(30);
  fill("black");
